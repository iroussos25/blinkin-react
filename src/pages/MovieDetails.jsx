...
const MovieDetails = () => {
    ...
    async function getPlot() {
        const movies = await fetch(`http://www.omdbapi.com/?i=${movie.imdbID}&plot=full&apikey=279e89f2`)
        const plot = await movies.json
        console.log(plot)
})
    }

    // function displayPlot(movie){
        // return
    // }
...
//                                     Genre
//                                 </p>
//                                 <a href={`http://www.omdbapi.com/?i=${movie.imdbID}&plot=full&apikey=279e89f2`} target="_blank">View on IMDb</a>
